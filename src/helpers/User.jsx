...
const SkillInfo = [
  ...
  {
    title: 'Back-end',
    skills: ['ExpressJS', 'ASP.NET', 'Django', 'FastAPI', 'Gin', 'Fiber', 'SpringBoot', 'MySQL', 'PostgreSQL', 'MongoDB', 'Redis', 'RabbitMQ']
  },
  {
    title: 'Languages',
    skills: ['GO', 'JavaScript', 'TypeScript', 'Python', 'Java', 'C#', 'SQL']
  },
  {
    title: 'Tools',
    skills: ['GitHub', 'Jupyter', 'Tableau', 'PowerBI', 'WordPress', 'Figma', 'Jira']
  },
  {
    title: 'DevOps',
    skills: ['Docker', 'Ubuntu', 'AWS', 'GCP', 'GHA']
  }
]
