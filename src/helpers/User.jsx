...
const ProjectInfo = [
  {
    ...
    desc: "A scalable hotel booking platform designed with a microservices architecture, using gRPC for high-performance inter-service communication. Built with a polyglot stack including C#, ASP.NET and integrating both SQL databases alongside other modern technologies.",
    image: "hotel-booking-microservice_prj.png",
    live: true,
    technologies: [
      "ASP.NET",
      "Docker",
    ...
    link: "https://staysaga.tienhai.site",
    github: "https://github.com/tienhai2808/stay_saga-infra",
    feCode: null,
    beCode: null,
  },
  {
...
const ExperienceInfo = [
  {
    ...
    company: "Frontier X Solutions",
    date: "Dec 2025 - Present",
    desc: "I led software development with Golang, Python, and React, creating scalable microservices and interfaces. I optimized performance by integrating frontend and backend, and enhanced security with RESTful APIs. Collaborating in agile teams, I fostered innovation and efficiency for top-quality solutions.",
    skills: [
      "Golang",
      "React JS",
      "Python",
  ...
  },
  {
    ...
    desc: "I leveraged my skills in Golang, Python, Github Action and CI/CD to develop an AI-integrated comic book printing system. I optimized database performance and reliability, and collaborated with cross-functional teams to enhance system operations and ensure seamless integration.",
    skills: [
      "Golang",
      "Python",
      "GitHub Action",
