...
import { ExperienceInfo } from "../helpers/User";
...
const TimelineItem = (items) => {
  ...
  return items.map((item, index) => (
    ...
    >
      <div className="border shadow-[0_0_10px_0_#8cf8f8] hover:-translate-y-2 transition transform duration-300 ease-in-out flex flex-col gap-2 border-primaryColor p-4 rounded-2xl sm-mx:p-3">
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center items-center">
        <Timeline className="xs-mx:w-[90%]" color="#8cf8f8" active={5} bulletSize={dot} lineWidth={2}>
          {TimelineItem(ExperienceInfo)}
          <Timeline.Item
            bullet={
              <IconBriefcaseFilled className="!text-bgColor" size={size} />
            }
          ></Timeline.Item>
        </Timeline>
      </div>
